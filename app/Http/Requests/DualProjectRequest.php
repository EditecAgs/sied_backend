...
class DualProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'internal_advisor_name' => ['nullable', 'string', 'max:255'],
            'internal_advisor_qualification' => ['nullable', 'integer', 'min:0', 'max:100'],
            'external_advisor_name' => ['nullable', 'string', 'max:255'],
            'external_advisor_qualification' => ['nullable', 'integer', 'min:0', 'max:100'],
            'economic_benefit' => ['nullable', 'integer', 'min:0'],
            'economic_benefit_note' => ['nullable', 'string', 'max:255'],
            'time_benefit' => ['nullable', 'integer', 'min:0'],
            'time_benefit_note' => ['nullable', 'string', 'max:255'],
